            ...
            <section class="flex flex-col break-words bg-red-500 sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="name" type="text" class="form-input rounded w-full h-8 bg-gray-800 @error('name')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password-confirm" type="password" class="form-input rounded w-full h-8 bg-gray-800"
                    ...
                    <div class="flex flex-wrap justify-center items-center">
                        ...
                        <p class="w-full text-lg text-center text-gray-700 my-6 sm:text-lg sm:my-8">
