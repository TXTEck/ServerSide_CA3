    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-red-500 sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <header class="font-semibold bg-red-500 text-gray-700 py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                    {{ __('Register') }}
                </header>
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="name" type="text" class="form-input w-full bg-gray-800 @error('name')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password-confirm" type="password" class="form-input w-full bg-gray-800"
